...
the ‘==’ is asking to output things that are equal to what I am asking
...
``` r
filter(litters_df, pups_born_alive >= 20)
```
...
Let’s look at how this works with character variables
